...
```go
import "github.com/cdktf/cdktf-provider-dnsimple-go/dnsimple/v10/datadnsimplecertificate"
...
&datadnsimplecertificate.DataDnsimpleCertificateConfig {
	...
	CertificateId: *f64,
	Domain: *string,
	Timeouts: github.com/cdktf/cdktf-provider-dnsimple-go/dnsimple/v10.dataDnsimpleCertificate.DataDnsimpleCertificateTimeouts,
}
```
