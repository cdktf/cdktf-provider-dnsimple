...
// https://registry.terraform.io/providers/dnsimple/dnsimple/1.9.1/docs/resources/domain_delegation
...
export class DomainDelegation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainDelegation that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.9.1/docs/resources/domain_delegation#import import section} in the documentation of this resource for the id to use
