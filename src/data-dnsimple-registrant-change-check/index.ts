// https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/data-sources/registrant_change_check
...
export class DataDnsimpleRegistrantChangeCheck extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsimpleRegistrantChangeCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.1/docs/data-sources/registrant_change_check#import import section} in the documentation of this resource for the id to use
