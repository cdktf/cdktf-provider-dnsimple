...
// https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.0/docs/resources/ds_record
...
export class DsRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.3.0/docs/resources/ds_record#import import section} in the documentation of this resource for the id to use
