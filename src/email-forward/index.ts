...
// https://registry.terraform.io/providers/dnsimple/dnsimple/1.7.0/docs/resources/email_forward
...
export class EmailForward extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailForward that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.7.0/docs/resources/email_forward#import import section} in the documentation of this resource for the id to use
