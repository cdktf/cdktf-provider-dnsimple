...
// https://registry.terraform.io/providers/dnsimple/dnsimple/1.9.0/docs/data-sources/certificate
...
export class DataDnsimpleCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsimpleCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.9.0/docs/data-sources/certificate#import import section} in the documentation of this resource for the id to use
