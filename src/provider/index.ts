// https://registry.terraform.io/providers/dnsimple/dnsimple/1.7.0/docs
...
export class DnsimpleProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing DnsimpleProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.7.0/docs#import import section} in the documentation of this resource for the id to use
